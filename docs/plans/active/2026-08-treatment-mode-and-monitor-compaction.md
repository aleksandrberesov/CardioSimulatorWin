...
> - Note: the SR→representative resolver picks `ids[0]`, which can be a non-canonical sinus rhythm (e.g. an AV-block entry tagged SR) — a later refinement could prefer a canonical rhythm per category. Core engine/drug-catalog UNCHANGED.
>
